<?php /*a:1:{s:66:"D:\phpstudy_pro\WWW\shang-ming-bei\app\index\view\index\index.html";i:1635864859;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<body>
  ...
  <div id="banner">
    <div class="banner-img">
      <img src="../imgs/index-bg.jpg" alt="">
    </div>
    <div class="banner-txt">
      <div class="banner-title  wow fadeInLeft2">劳模工作室</div>
      <div class="banner-slogan  wow fadeInLeft2">
        帮助您提升组织绩效是我们的使命
      </div>
      <a href="index.html" class="banner-btn  wow fadeInLeft2">
        了解详情
      </a>
    </div>
  </div>
        ...
        <div class="section-content section4-content">
          <div class="team-box  wow fadeInUp d2">
            ...
            <div class="team-desc">
              <span>创始人：尚明怀</span>
              <p>
                这些圆的末端保持友好和可接近的，如图，你会注意到使用单一色调或使用渐变来定义形状和距离的效果同样令人印象深刻。
              </p>
            </div>
          </div>
          <div class="team-box  wow fadeInUp d2">
      ...
      <div class="section-box">
        ...
        <div class="section-content section5-content">
          <div class="case-box  wow fadeInUp d2">
            <img src="../imgs/TCL.jpg" alt="">
          </div>
          <div class="case-box  wow fadeInUp d2">
            <img src="../imgs/fangzheng.jpg" alt="">
          </div>
          <div class="case-box wow fadeInUp d2">
            <img src="../imgs/TCL.jpg" alt="">
          </div>
            ...
            <a href="#">
              ...
              <div class="news-content wow fadeInUp d2">
                <div class="news-title">
                  “破局·赋能·创新”2020年人才引进与组织发展......
                </div>
                <div class="news-desc">
                  1月11日，2020年人才引进与组织发展高峰论坛暨深圳市中小企业最佳雇主颁奖典礼在深圳市人才园举办。
                </div>
              </div>
              ...
              <a href="#">
                <div class="news-content">
                  <div class="news-list-title">
                    尚明怀讲故事：遇到管财务的老板娘什么样的体验？
                  </div>
                  <div class="news-list-desc">
                    4月24日，中华全国总工会召开2021年“五一”新闻发布会，1197人荣获2021年全国五一劳动奖章。
                  </div>
                </div>
