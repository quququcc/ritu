<?php /*a:1:{s:58:"D:\phpstudy_pro\WWW\da-wei\app\index\view\index\index.html";i:1638598398;}*/ ?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="section-content section3-content">
                ...
                <div class="course-box  wow fadeInUp d2">
                    <div class="course-img">
                        <a hef="personnel_details.html?id=<?php echo htmlentities($v['id']); ?>">
        ...
        <div class="section-box">
            ...
            <div class="section-content section6-content">
                <div class="news-index-left">
                    ...
                    <a href="news_details.html?id=<?php echo htmlentities($v['id']); ?>">
